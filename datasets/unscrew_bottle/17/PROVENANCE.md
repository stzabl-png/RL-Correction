# 数据来源 · egodex_part4/screw_unscrew_bottle_cap__17

帧数 101 · variant `dev` · 生成于本目录的 `world_fused.npz`
...
| 深度 | ****重建**** | ViPE 估计，再按 depth_scale=0.3855589372107406 缩放到真实米制 |
...
| conf_pos / conf_rot | ****估计**** | 87.0 / 69.0，判定 good |
