...
RUN = ROOT / 'logs/task1_fixed_20260909/cube15'
...
ref = ROOT/'tasks/Sweep/new_data/references/take9_powerdisk_fixed_cube15_v1.npz'
conf = ROOT/'tasks/Sweep/new_data/configs/take9_powerdisk_fixed_cube15_v1.json'
...
cfg['task_name'] = 'Task3Take9FixedThinEntryCube15'
cfg['training_geometry']['cube_half'] = half
cfg['training_geometry']['pan_center_y_max'] -= .005
...
cfg['training_input'].update(contact_row=row, contact_source_frame=float(z['source_frame'][row]),
    cube_placement_audit='logs/task1_fixed_20260909/cube15/take9_cube_v2_report.json')
