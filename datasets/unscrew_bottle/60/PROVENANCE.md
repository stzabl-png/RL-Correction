# 数据来源 · egodex_part4/screw_unscrew_bottle_cap__60

帧数 134 · variant `dev` · 生成于本目录的 `world_fused.npz`
...
| 深度 | ****重建**** | ViPE 估计，再按 depth_scale=0.37104574355708175 缩放到真实米制 |
...
| conf_pos / conf_rot | ****估计**** | 79.5 / 61.5，判定 good |
