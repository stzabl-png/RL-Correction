...
Used by ``switch_frame.py`` to find a hand pose along the retargeted replay
that is safely clear of the object before switching into the synthetic
approach segment. Torch/CUDA (grasp-synthesis conda env).
