...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--penetration-weight", type=float, default=900.0, help="Weight of the asymmetric all-sphere non-penetration energy (relu(-sdf)^2 summed); 0 disables it. Active during stage 0 only, keeping the force-closure/pose-prior search at the 2cm standoff out of the mesh; the tracking stages (1-2) run without it.")
