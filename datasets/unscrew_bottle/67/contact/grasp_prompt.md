...
来源 take: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/67`
...
- 物体网格: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/67/objects/object_0/object_mesh_scaled_final.obj`
- 尺寸: [0.065, 0.065, 0.197] m, 主轴 z
- 抓握发生在第 36~45 帧(10 帧)

**接触区在物体上的位置**

- 沿主轴高度: **0% ~ 29%**(中位 12%, 0=最低端)
- 绕主轴方位跨度: **120°**
- 离轴距离: 物体最大半径的 99%
- 热点数 1499(占表面 2.5%)
...
- 对生度 0.46(≥0.40 才算抓握; 0.5≈环抱180°)
- 手部体检 0.357(正常 0.55~0.63)
- 物体体检 0.709(健康 0.45~0.69)
- 手到物体表面 0.14 mm
- 物体位姿可信度 conf_pos=88.0 conf_rot=60.0
- **只覆盖相机可见的一面**: 自遮挡门删掉 86% 的背面点; 方位跨度 120° 是**下界**, 真实包裹只多不少
- 同一段视频里还有 8 个不同的稳定抓握
- 精确点云: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/67/contact/contact_v2_object_0_left.ply`(可直接拖进 MeshLab)
