# 数据来源 · egodex_part4/screw_unscrew_bottle_cap__89

帧数 98 · variant `dev` · 生成于本目录的 `world_fused.npz`
...
| 深度 | ****重建**** | ViPE 估计，再按 depth_scale=0.4211224360814078 缩放到真实米制 |
...
| conf_pos / conf_rot | ****估计**** | 85.0 / 80.5，判定 good |
