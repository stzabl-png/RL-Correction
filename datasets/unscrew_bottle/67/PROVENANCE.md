# 数据来源 · egodex_part4/screw_unscrew_bottle_cap__67

帧数 137 · variant `dev` · 生成于本目录的 `world_fused.npz`
...
| 深度 | ****重建**** | ViPE 估计，再按 depth_scale=0.2686722508835747 缩放到真实米制 |
...
| conf_pos / conf_rot | ****估计**** | 88.0 / 66.0，判定 good |
