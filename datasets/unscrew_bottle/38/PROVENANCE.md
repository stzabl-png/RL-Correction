# 数据来源 · egodex_part4/screw_unscrew_bottle_cap__38

帧数 110 · variant `dev` · 生成于本目录的 `world_fused.npz`
...
| 深度 | ****重建**** | ViPE 估计，再按 depth_scale=0.2895024818635723 缩放到真实米制 |
...
| conf_pos / conf_rot | ****估计**** | 85.5 / 59.5，判定 good |
