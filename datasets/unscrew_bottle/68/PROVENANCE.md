# 数据来源 · egodex_part4/screw_unscrew_bottle_cap__68

帧数 138 · variant `dev` · 生成于本目录的 `world_fused.npz`
...
| 深度 | ****重建**** | ViPE 估计，再按 depth_scale=0.3302307577266296 缩放到真实米制 |
...
| conf_pos / conf_rot | ****估计**** | 80.0 / 65.5，判定 good |
