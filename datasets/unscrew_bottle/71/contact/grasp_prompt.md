...
来源 take: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/71`
...
- 物体网格: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/71/objects/object_0/object_mesh_scaled_final.obj`
- 尺寸: [0.065, 0.065, 0.197] m, 主轴 z
- 抓握发生在第 8~15 帧(8 帧)

**接触区在物体上的位置**

- 沿主轴高度: **5% ~ 29%**(中位 19%, 0=最低端)
- 绕主轴方位跨度: **90°**
- 离轴距离: 物体最大半径的 99%
- 热点数 404(占表面 0.7%)
...
- 手部体检 0.328(正常 0.55~0.63)
- 物体体检 0.61(健康 0.45~0.69)
- 手到物体表面 0.08 mm
- 物体位姿可信度 conf_pos=72.0 conf_rot=71.5
- **只覆盖相机可见的一面**: 自遮挡门删掉 95% 的背面点; 方位跨度 90° 是**下界**, 真实包裹只多不少
- 同一段视频里还有 3 个不同的稳定抓握
- 精确点云: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/71/contact/contact_v2_object_0_left.ply`(可直接拖进 MeshLab)
...
- `object_1 × right`: **no_stable_contact** —— 窗口 3 帧 < 门槛 5 帧, 判无稳定抓握
