...
来源 take: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/51`
...
- 物体网格: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/51/objects/object_0/object_mesh_scaled_final.obj`
...
- 手部体检 0.305(正常 0.55~0.63)
- 物体体检 0.68(健康 0.45~0.69)
- 手到物体表面 0.06 mm
- 物体位姿可信度 conf_pos=76.0 conf_rot=61.5
- **只覆盖相机可见的一面**: 自遮挡门删掉 83% 的背面点; 方位跨度 150° 是**下界**, 真实包裹只多不少
- 同一段视频里还有 8 个不同的稳定抓握
- 精确点云: `/home/yanghong/Reconstruct_and_Retarget/Output/ReconstructOutput/egodex_part4/screw_unscrew_bottle_cap/51/contact/contact_v2_object_0_left.ply`(可直接拖进 MeshLab)
