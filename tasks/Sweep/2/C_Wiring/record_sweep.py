...
p.add_argument("--task_config", default=os.environ.get("SWEEP_TASK_CONFIG", ""),
               help="Optional tasks/Sweep/new_data/configs/take_<id>.json")
