# 数据来源 · egodex_part4/screw_unscrew_bottle_cap__37

帧数 105 · variant `dev` · 生成于本目录的 `world_fused.npz`
...
| 深度 | ****重建**** | ViPE 估计，再按 depth_scale=0.25846051385253643 缩放到真实米制 |
...
| conf_pos / conf_rot | ****估计**** | 83.0 / 68.0，判定 good |
...
物体（LLM 标注）：['cap', 'metal water bottle']
