# Copied verbatim from GR00T-WholeBodyControl decoupled_wbc/control/teleop/device/pico/xr_client.py
# (thin xrobotoolkit_sdk wrapper; copied to avoid importing decoupled_wbc). py3.10 only.
import numpy as np
