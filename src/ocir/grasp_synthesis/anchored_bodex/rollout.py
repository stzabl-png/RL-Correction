...
- adds guidance costs on top of the exact BODex staged cost (which, as in
  original BODex, runs the force-closure QP energy in stage 0 only and has
  stages 1-2 track the contact targets frozen at the stage-0 switch):
